...
def getitems(item_code=""):
     return frappe.db.sql("""SELECT item_type,volume,item_name, item_group,generic_name,stock_uom,brand_name,description FROM `tabItem` WHERE item_code= %s""", item_code, as_dict=1);
